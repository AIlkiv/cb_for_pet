...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            @if(!empty($button_bulk_action) && ( (!empty($button_delete) && CRUDBooster::isDelete()) || !empty($button_selected)) )
                <div class="pull-{{ trans('crudbooster.left') }}">
                    <div class="selected-action" style="display:inline-block;position:relative;">
                        ...
                        <ul class="dropdown-menu">
                            @if(!empty($button_delete) && CRUDBooster::isDelete())
